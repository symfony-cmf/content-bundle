...
namespace Symfony\Cmf\Bundle\ContentBundle\Tests\Unit\DependencyInjection;
...
class XmlSchemaTest extends XmlSchemaTestCase
{
    public function testSchema()
    {
        ...
        $this->assertSchemaAcceptsXml($xmlFiles, __DIR__.'/../../../src/Resources/config/schema/content-1.0.xsd');
    }
}
